...
class LoginWindow(tk.Toplevel):
    def __init__(self, master):
        ...
        self.background_image = Image.open("C:\\Users\\Venzic Barbosa\\Desktop\\BDA_Project\\man1.jpg") # Change "login_background.jpg" to your image path
...
anime_data = pd.read_csv('C:\\Users\\Venzic Barbosa\\Desktop\\BDA_Project\\anime.csv')
...
class RecommendationsWindow(tk.Toplevel):
    def __init__(self, master, recommendations):
        ...
        background_image = Image.open("man1.jpg")
...
class AnimeRecommendationApp:
    ...
    def __init__(self, master):
        ...
        background_image = Image.open("C:\\Users\\Venzic Barbosa\\Downloads\\street1.jpg")
        background_photo = ImageTk.PhotoImage(background_image)
